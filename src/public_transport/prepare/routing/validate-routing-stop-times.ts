...
interface SequencedRoutingStopTime extends RoutingStopTime {
...
export function validateRoutingStopTimes(
  ...
  const stopTimes: readonly SequencedRoutingStopTime[] = entries.map((entry) => {
  ...
  return Object.freeze(
    sortedStopTimes.map((stopTime) =>
      Object.freeze({
        stopId: stopTime.stopId,
        arrivalTimeSeconds: stopTime.arrivalTimeSeconds,
        departureTimeSeconds: stopTime.departureTimeSeconds,
