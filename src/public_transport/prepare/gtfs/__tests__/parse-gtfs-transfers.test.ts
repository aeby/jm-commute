...
const COLUMNS = createGtfsTransferColumnIndexes(HEADER.split(','));
const parseRow = (row: string) => parseGtfsTransferRow(row.split(','), COLUMNS);

describe('parseGtfsTransferRow', () => {
