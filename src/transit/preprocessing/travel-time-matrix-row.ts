...
/**
 * Creates the deterministic one-row compiler used by transit matrix
 * preprocessing. The injected query is the existing high-level fastest-window
 * locality query; stop-level RAPTOR details remain outside this module.
 */
