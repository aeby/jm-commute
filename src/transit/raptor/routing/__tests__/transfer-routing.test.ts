...
describe('RAPTOR transfer routing', () => {
  ...
  it('reports transfer edge work and improvements', () => {
    ...
    expect(diagnostics?.transferEdgesExamined).toBeGreaterThanOrEqual(1);
    expect(diagnostics?.transferArrivalImprovements).toBeGreaterThanOrEqual(1);
  });
